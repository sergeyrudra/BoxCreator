...
public class Box4 extends AbstractBox {
	@Override
	...
	int z = dbWorker.z - BoxSettings.getBoxSettings().getSettings(SettingsType.REAR_DEEP)
		...
		d = new Detail(CommonStatic.Details.RACK,
				(dbWorker.x / 2)
						- (BoxSettings.getBoxSettings().getSettings(SettingsType.DSP_THICK) + (BoxSettings.getBoxSettings().getSettings(SettingsType.DSP_THICK) / 2)), z, 1, 0,
