...
public class Box24 extends AbstractBox {
	@Override
	...
	public void create(DbWorker dbWorker) {		//ArrayList<Detail> details = new ArrayList<Detail>();
		...
		d = new Detail(CommonStatic.Details.FACADE, (int) Math. round (Math.sqrt(2*Math.pow((dbWorker.z-dbWorker.x-BoxSettings.getBoxSettings().getSettings(SettingsType.DSP_THICK)),2)))- BoxSettings.getBoxSettings().getSettings(SettingsType.FACADE_CLEARANCE), y- BoxSettings.getBoxSettings().getSettings(SettingsType.DSP_THICK)
