...
public class Box21 extends AbstractBox {
	@Override
	...
	public void create(DbWorker dbWorker) {
		...
		d = new Detail(CommonStatic.Details.BACK, z,
				dbWorker.y
						- (BoxSettings.getBoxSettings()
								.getSettings(SettingsType.DSP_THICK)), 0, 1, 2,
		...
		int facadeHeight=((dbWorker.y
				- BoxSettings.getBoxSettings().getSettings(
						SettingsType.SOCLE_Y) - (BoxSettings
				.getBoxSettings().getSettings(SettingsType.DSP_THICK) * 2)) / dbWorker.shelfQuantity)
				- BoxSettings.getBoxSettings().getSettings(
						SettingsType.FACADE_CLEARANCE);

		//верхние ящики

		d = new Detail(CommonStatic.Details.BACK_MIDDLE, z-BoxSettings.getBoxSettings().getSettings(
				SettingsType.DSP_THICK), facadeHeight, 0, 1,
				1, dbWorker.quantity,BoxSettings.getBoxSettings()
				.getSettings(SettingsType.EDGE_THICK));// перегородка для в. ящика
		details.add(d);

		d = new Detail(CommonStatic.Details.PULL_OUT_DRAWER_FACADE, ((dbWorker.x- (BoxSettings.getBoxSettings().getSettings(
				SettingsType.DSP_THICK) * 2))/2)
				- (BoxSettings.getBoxSettings().getSettings(
						SettingsType.FACADE_CLEARANCE)), facadeHeight, 2, 2, 2,
				dbWorker.quantity,BoxSettings.getBoxSettings()
		...
		d = new Detail(
				...
				((dbWorker.x
				- (BoxSettings.getBoxSettings().getSettings(
						SettingsType.DSP_THICK) * 3))/2)
				- (BoxSettings.getBoxSettings().getSettings(
						SettingsType.PULL_OUT_DRAWER_GUIDES_INDENT) * 2)- (BoxSettings.getBoxSettings().getSettings(
								SettingsType.DSP_THICK) * 2),
								facadeHeight
						- BoxSettings.getBoxSettings().getSettings(
								SettingsType.PULL_OUT_DRAWER_HEIGHT_INDENT),
				1, 0, 4, dbWorker.quantity,BoxSettings.getBoxSettings()
		...
		d = new Detail(CommonStatic.Details.PULL_OUT_DRAWER_BACK,
				CommonStatic.pullOutDrawerDeep(z
						- BoxSettings.getBoxSettings().getSettings(
								SettingsType.DSP_THICK)), facadeHeight
				- BoxSettings.getBoxSettings().getSettings(
						SettingsType.PULL_OUT_DRAWER_HEIGHT_INDENT), 1, 0, 4,
				dbWorker.quantity,BoxSettings.getBoxSettings()
		...
		d = new Detail(
				...
				CommonStatic.pullOutDrawerDeep(z
						...
						- BoxSettings.getBoxSettings().getSettings(
								SettingsType.REAR_MARG), 0, 0, 2,
				dbWorker.quantity);// дно ящика
		details.add(d);
//нижние ящики		
		d = new Detail(
				CommonStatic.Details.PULL_OUT_DRAWER_FACADE,
				dbWorker.x
						- (BoxSettings.getBoxSettings().getSettings(
								SettingsType.DSP_THICK) * 2)
						- BoxSettings.getBoxSettings().getSettings(
								SettingsType.FACADE_CLEARANCE),
								facadeHeight, 2, 2,
				dbWorker.shelfQuantity-1, dbWorker.quantity,BoxSettings.getBoxSettings()
				.getSettings(SettingsType.EDGE_THICK));// фасад ящика
		details.add(d);
		...
		d = new Detail(
				...
				dbWorker.x
						...
						- (BoxSettings.getBoxSettings().getSettings(
								...
								facadeHeight
						- BoxSettings.getBoxSettings().getSettings(
								SettingsType.PULL_OUT_DRAWER_HEIGHT_INDENT), 1,
				0, (dbWorker.shelfQuantity-1)*2, dbWorker.quantity,BoxSettings.getBoxSettings()
				.getSettings(SettingsType.EDGE_THICK));// перед/зад ящика
		details.add(d);
		...
		d = new Detail(
				...
				CommonStatic.pullOutDrawerDeep(z
						- BoxSettings.getBoxSettings().getSettings(
								SettingsType.DSP_THICK))
						- BoxSettings.getBoxSettings().getSettings(
								SettingsType.REAR_MARG), 0, 0, dbWorker.shelfQuantity-1,
				dbWorker.quantity);// дно ящика
		details.add(d);
