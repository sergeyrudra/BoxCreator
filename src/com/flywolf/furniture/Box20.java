...
public class Box20 extends AbstractBox {
	@Override
	...
	public void create(DbWorker dbWorker) {
		...
		d = new Detail(
				...
				0, dbWorker.shelfQuantity*2, dbWorker.quantity, BoxSettings.getBoxSettings()
		...
		d = new Detail(
				...
				CommonStatic.pullOutDrawerDeep(z
						...
						- BoxSettings.getBoxSettings().getSettings(
								SettingsType.REAR_MARG), 0, 0, dbWorker.shelfQuantity,
